...
RET_VOID_NAKE GetViewingStatsPlayerPatch1_ASM()
{
	__asm {
		push eax
...
RET_VOID_NAKE GetViewingStatsPlayerPatch2_ASM()
{
	__asm {
		push eax
		call GetViewStatUnit
...
RET_VOID_NAKE GetUnitDrawEquipItemPatch_ASM()
{
	__asm {
		push eax;
		call GetViewEquUnit;
...
RET_VOID_NAKE GetUnitDrawItemDescPath_ASM()
{
	__asm {
		push eax;
		call GetViewEquUnit;
...
RET_VOID_NAKE GetUnitTestHasItem_ASM()
{
	__asm {
//edi = default unit
		push eax
...
RET_VOID_NAKE GetUnitDrawInvItemPatch_ASM(){
	__asm {
...
RET_VOID_NAKE GetUnitProtectClickEquipPatch_ASM(){
	__asm {
		call GetViewEquUnit;
...
RET_VOID_NAKE GetUnitProtectClickInvPatch_ASM(){
	__asm {
		push eax
		call GetViewEquUnit;
