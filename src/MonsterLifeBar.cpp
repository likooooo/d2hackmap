...
RET_VOID_NAKE MonsterNamePatch_ASM()
{
	//ecx  wszName
	//edx  xpos
	//ebx  pUnit
...
RET_VOID_NAKE MonsterDescCommaPatch1_ASM()
{
	__asm {
...
RET_VOID_NAKE MonsterDescCommaPatch2_ASM()
{
	__asm {
...
RET_VOID_NAKE MonsterDescCommaPatch3_ASM()
{
	__asm {
//ecx = ptr string
...
RET_VOID_NAKE LifeBarPatch_ASM()
{
	__asm {
		pop ebp
//originalish code
