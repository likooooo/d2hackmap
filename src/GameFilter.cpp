...
RET_VOID_NAKE D2MCPPacketHandler_05_Patch_ASM()
{
	__asm{
		pop eax  //ret addr
...
RET_VOID_NAKE CreateGameBoxPatch_ASM()
{
	__asm{
...
RET_VOID_NAKE GameListRefreshTimePatch_ASM()
{
...
RET_VOID_NAKE DrawGameListPatch_ASM()
{
